...
**热点主题信息的用途**：让 subagent 在估值和长期 thesis 判断时知道"当前宏观叙事正关注什么赛道"，帮助判断该股的估值锚是否有行业景气度支撑、盈利预测是否可能受益于宏观/产业叙事驱动、当前价格是否透支了主题预期，避免孤立的基本面分析漏掉宏观产业趋势。
...
主 agent 在完成合并和 P1 刷新后，检查不同股票间的逻辑冲突，二次裁决并回写。
