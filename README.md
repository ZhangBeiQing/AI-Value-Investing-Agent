...
核心就四个字：**低买高卖**。所有决策围绕估值印象展开——明显低估 / 偏低估时分批建仓，明显高估 / 泡沫时卖出，不设机械止盈止损，充分发挥主观能动性。

具体怎么做？融合了基金经理**程浩然的产业链研究方法**：

1. **选行业**：找到一条需求爆发的产业链，行业总量判断只花 20% 的时间，却占投资决策 70% 的权重
2. **选龙头**：在供需错配的环节里挑出龙头公司——龙头信息透明、资金容量大、上行涨得多、下行跌得少
3. **买在基本面右侧**：不猜市场底，基本面已快速改善时即可买入，不必等股价见底
4. **长线持有**：一个产业周期通常持续 3-5 年甚至更久，耐心等待业绩兑现
5. **到天花板卖出**：景气度指标恶化或触及理论市值天花板时果断离场

落实到个股，我们把公司分成三类来形成估值印象：

| 类型 | 特点 | 赚钱逻辑 | 例子 |
| --- | --- | --- | --- |
| 周期型 | 净利润随商品价格大幅波动 | 盯 PB 和历史价格区间，周期底部买、顶部卖 | 牧原股份、中国船舶 |
| 稳定型 | 营收利润稳定，扣非 PE 在一定范围震荡 | 历史 PE/价格区间内低买高卖 | 海康威视、宁德时代 |
| 爆发型 | 业绩爆发式增长，高 PE 能被增速消化 | 赚业绩增长的钱，判断高增长能持续多久 | AI 硬件、创新药 |

同时想清楚：你赚的是**估值回归**的钱，还是**业绩增长**的钱？前者靠分批建仓摊薄成本，后者靠选对行业和龙头，在景气上行期坚定持有。

完整策略细节见 `configs/prompt_flow/fixed_tracked/investment_policy.md`，该文件是 fixed_tracked 全部 Agent 共用的核心投资策略单一来源。如需调整规则，直接修改该文件即可。
